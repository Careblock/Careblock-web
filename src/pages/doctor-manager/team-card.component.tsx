...
const BaseTeamCard = ({ dataSource, onClickRemove, onClickGrant, onClickEdit }: BaseCardProps) => {
    return (
        <div className="shadow-md rounded-lg w-[280px] h-[284px] overflow-hidden flex flex-col items-center justify-between py-[16px] pt-[20px] cursor-pointer hover:bg-[#f2f2f2] select-none">
